        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div
                    ...
                    <form editor-attach action="{{ route('admin.berita.store') }}" method="POST">
                        @csrf
                        <div class="space-y-6">
                            <!-- Nama Artikel -->
                            ...
                            <div class="flex items-center gap-2 mb-4">
                                ...
                                <div class="relative inline-block w-50">
                                    ...
                                    <button type="button"
                                        ...
                                        <span id="selected">Jenis Artikel </span>
                                ...
                                <input required type="text" name="nama_berita" placeholder="Nama Berita..."
                            ...
                            <div class="flex justify-center items-center flex-col">
                                <x-label class="w-full mb-2" for="deskripsi" value="{{ __('Deskripsi') }}" />
                                <div id="deskripsi" rows="10"
                                    class="bg-white w-full rounded-b-xl min-h-[200px]">{{ old('deskripsi', "") }}</div>
                            </div>
