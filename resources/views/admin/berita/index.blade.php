                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td class="px-6 py-4">
                                        <img src="{{ Storage::url($berita->foto) }}" alt="{{ $berita->nama_berita }}" class="w-20 h-16 object-cover rounded">
                                    </td>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end items-center space-x-4">
                                            ...
                                            <div x-data="{ open: false }">
                                                <button @click="open = true" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Lihat</button>

                                                <div x-show="open" @click.away="open = false" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-75" style="display: none;">
                                                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 max-w-2xl w-full mx-4">
                                                        <div class="flex justify-between items-center border-b dark:border-gray-700 pb-3 mb-4">
                                                            <h3 class="text-lg font-bold text-gray-900 dark:text-white">{{ $berita->nama_berita }}</h3>
                                                            <button @click="open = false" class="text-gray-500 hover:text-gray-700 dark:hover:text-white text-2xl">&times;</button>
                                                        </div>
                                                        <div class="space-y-4 text-left">
                                                            <img src="{{ Storage::url($berita->foto) }}" alt="{{ $berita->nama_berita }}" class="w-full h-64 object-cover rounded-md mb-4">
                                                            <p class="text-gray-600 dark:text-gray-300 whitespace-pre-wrap">{{ $berita->deskripsi }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

                                            <a href="{{ route('admin.berita.edit', $berita) }}" class="font-medium text-yellow-600 dark:text-yellow-500 hover:underline">Edit</a>
                                            ...
                                            <div x-data="{ open: false }">
                                                ...
                                                <div x-show="open" @click.away="open = false" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" style="display: none;">
                                                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6">
                                                        ...
                                                        <p class="text-gray-600 dark:text-gray-400 mb-6">Apakah Anda yakin ingin menghapus berita "{{ $berita->nama_berita }}"?</p>
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">Tidak ada berita yang ditemukan.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
