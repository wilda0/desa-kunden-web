@section('title', content: 'Admin - Tambah Layanan')
<x-app-layout>
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div
                    ...
                    <form editor-attach="true" id="layananForm" action="{{ route('admin.layanan.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="space-y-6">
                            <!-- Nama Layanan -->
                            ...
                            <div>
                                ...
                                <div id="deskripsi" class="bg-white rounded-b-xl">{{ old('deskripsi') }}</div>
                            </div>
