        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 dark:bg-gradient-to-bl dark:from-gray-700/50 dark:via-transparent border-b border-gray-200 dark:border-gray-700">
                    ...
                    {{-- Tombol Tambah Data --}}
                    <div class="mb-4">
                        <a href="{{ route('admin.produk-umkm.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500 active:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition ease-in-out duration-150">
                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    ...
                                    <td class="px-6 py-4 text-gray-600 dark:text-gray-400 text-xs max-w-xs truncate" title="{{ $produk->deskripsi }}">
                                        {{ $produk->deskripsi }}
                                    </td>
                                    <td class="px-6 py-4 text-right">
                                        <div class="flex justify-end items-center space-x-3">
                                            {{-- Tombol Edit --}}
                                            <a href="{{ route('admin.produk-umkm.edit', $produk->id) }}" class="font-medium text-yellow-600 dark:text-yellow-500 hover:underline">Edit</a>
                                            ...
                                            <div x-data="{ open: false }">
                                                ...
                                                <div x-show="open" @click.away="open = false" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50" style="display: none;">
                                                    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-6 w-full max-w-md">
                                                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mb-4 text-left">Konfirmasi Hapus</h3>
                                                        <p class="text-gray-600 dark:text-gray-400 mb-6 text-left">Apakah Anda yakin ingin menghapus produk "{{ $produk->nama_produk }}"?</p>
                                                        <div class="flex justify-end space-x-4">
                                                            ...
                                                            <form action="{{ route('admin.produk-umkm.destroy', $produk->id) }}" method="POST" class="inline">
                                                                @csrf
                                                                @method('DELETE')
