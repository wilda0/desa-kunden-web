        ...
        <div class="flex items-center justify-between flex-wrap">
            ...
            <div class="shrink-0 sm:ms-3">
                <button
                    ...
                    :class="{ 'hover:bg-indigo-600 focus:bg-indigo-600': style == 'success', 'hover:ed-600 focus: bg-red-600': style == 'danger', 'hover:bg-yellow-600 focus:bg-yellow-600': style == 'warning'}"
                    aria-label="Dismiss"
