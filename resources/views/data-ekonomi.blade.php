                            ...
                            <table class="min-w-full text-sm">
                                ...
                                <tbody class="divide-y divide-gray-100">
                                    <tr>
                                        ...
                                        <td class="px-4 py-3 text-gray-800 text-right font-medium">145 ha</td>
                                    </tr>
                                    <tr>
                                        <td class="px-4 py-3 text-gray-700">Padi Ladang</td>
                                        <td class="px-4 py-3 text-gray-800 text-right font-medium">48 ha</td>
                                    </tr>
                                    <tr>
                                        <td class="px-4 py-3 text-gray-700">Jagung</td>
                                        <td class="px-4 py-3 text-gray-800 text-right font-medium">9 ha</td>
                                    </tr>
                                    <tr>
                                        <td class="px-4 py-3 text-gray-700">Palawija</td>
                                        <td class="px-4 py-3 text-gray-800 text-right font-medium">10 ha</td>
                                    </tr>
                                    <tr>
                                ...
                                <table class="min-w-full text-sm">
                                    ...
                                    <tbody class="divide-y divide-gray-100">
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 text-gray-800 text-right font-medium">1.145 Orang</td>
                                        </tr>
                                        <tr>
                                            <td class="px-4 py-3 text-gray-700">Pedagang</td>
                                            <td class="px-4 py-3 text-gray-800 text-right font-medium">63 Orang</td>
                                        </tr>
                                        <tr>
                                            <td class="px-4 py-3 text-gray-700">PNS</td>
                                            <td class="px-4 py-3 text-gray-800 text-right font-medium">24 Orang</td>
                                        </tr>
                                        <tr>
                                            <td class="px-4 py-3 text-gray-700">Tukang</td>
                                            <td class="px-4 py-3 text-gray-800 text-right font-medium">18 Orang</td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-4 py-3 text-gray-800 text-right font-medium">3 Orang</td>
                                        </tr>
                                        <tr>
                                            <td class="px-4 py-3 text-gray-700">Pensiunan</td>
                                            <td class="px-4 py-3 text-gray-800 text-right font-medium">15 Orang</td>
                                        </tr>
                                        <tr>
                                            <td class="px-4 py-3 text-gray-700">Sopir/Angkutan</td>
                                            <td class="px-4 py-3 text-gray-800 text-right font-medium">48 Orang</td>
                                        </tr>
                                        <tr>
                                            <td class="px-4 py-3 text-gray-700">Buruh</td>
                                            <td class="px-4 py-3 text-gray-800 text-right font-medium">45 Orang</td>
                                        </tr>
                                        <tr>
                                            <td class="px-4 py-3 text-gray-700">Jasa Persewaan</td>
                                            <td class="px-4 py-3 text-gray-800 text-right font-medium">32 Orang</td>
                                        </tr>
                                        <tr>
                                            <td class="px-4 py-3 text-gray-700">Swasta</td>
                                            <td class="px-4 py-3 text-gray-800 text-right font-medium">1.235 Orang</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
        ...
        document.addEventListener('DOMContentLoaded', (event) => {
            ...
            new Chart(pekerjaanCtx, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Jumlah Orang',
                        data: [1145, 63, 24, 18, 24, 1, 3, 15, 48, 45, 32, 1235],
                        backgroundColor: [
