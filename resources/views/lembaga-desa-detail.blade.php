        ...
        <div class="container mx-auto px-6 lg:px-16 py-12 flex flex-col space-y-8">
            ...
            <div class="mb-8">
                <nav class="text-sm mb-4 text-gray-500">
                    ...
                    <span class="text-gray-700">lembaga Desa</span>
                </nav>
                <h1 class="text-4xl font-bold text-gray-800">lembaga Desa</h1>
                <p class="text-gray-500 mt-2">Lembaga - Lembaga yang ada didesa kunden</p>
            </div>
            ...
            <div class="w-full h-full bg-white rounded-2xl flex">
                ...
                <div class="container mx-auto max-w-4xl p-4 md:p-8">
                    ...
                    <main class="w-full kontent-lembaga">
                        <article>
                            <header class="my-8">
                                <h1 id="nama_lembaga" class="text-6xl lg:text-8xl font-bold text-gray-900 mb-4">
                                    {{ $lembaga->nama_lembaga }}</h1>
                                <div
                                    class="text-gray-500 outline-1 outline-slate-700 outline-dashed p-2 text-sm md:text-base flex items-center space-x-2">
