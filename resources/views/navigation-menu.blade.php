            ...
            <div class="flex justify-between h-20 items-center">
                ...
                <nav class="hidden md:flex items-center space-x-2">
                    ...
                    <a href="{{ route('admin.layanan.index') }}"
                        class="{{ request()->routeIs('admin.layanan.*') ? 'text-indigo-600 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white' }} px-3 py-2 rounded-md text-sm">
                        Layanan
                    </a>
                    <a href="{{ route('admin.lembaga.index') }}"
                        class="{{ request()->routeIs('admin.lembaga.*') ? 'text-indigo-600 dark:text-indigo-400 font-semibold' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white' }} px-3 py-2 rounded-md text-sm">
                        Lembaga
                    </a>
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block relative ml-4 group">
                        <button
                            ...
                            <svg class="h-4 w-4 text-gray-500 dark:text-gray-300" fill="none" viewBox="0 0 20 20"
                                stroke="currentColor">
                        ...
                        <div
                            ...
                            <div class="py-1 border-t border-gray-200 dark:border-gray-600">
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <button type="submit"
                                        class="w-full text-left px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:ed-50 dark:hover:ed-500/10">
                                        Logout
                                    </button>
                                </form>
                            </div>
                    ...
                    <div class="md:hidden ml-4">
                        <button id="mobile-menu-toggle"
                            class="inline-flex items-center justify-center p-2 rounded-md text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
            ...
            <div class="pt-4 pb-3 border-t border-gray-200 dark:border-gray-700">
                <div class="flex items-center px-5">
                    ...
                    <div class="ml-3">
                        ...
                        <div class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ Auth::user()->email }}
                        </div>
                    </div>
                </div>
                <div class="mt-3 px-2 space-y-1">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="w-full text-left block px-3 py-2 rounded-md text-base font-medium text-red-600 dark:text-red-400 hover:ed-50 dark:hover:ed-500/10">
                            Logout
                        </button>
                    </form>
                </div>
