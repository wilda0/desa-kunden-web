            ...
            <div class="bg-white p-8 rounded-lg shadow-md max-w-4xl mx-auto">
                <form action="{{-- route('permohonan.store') --}}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <!-- Asal Instansi -->
                        <div>
                            <label for="instansi" class="block text-sm font-medium text-gray-700 mb-1">Asal Instansi
                        ...
                        <!-- Nomor Telepon -->
                        <div>
                            <label for="telepon" class="block text-sm font-medium text-gray-700 mb-1">Nomor Telepon
                                <span class="text-red-500">*</span></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <input type="tel" name="telepon" id="telepon"
                                    class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                                    placeholder="Masukkan nomor telepon Anda (08xxxxx)" pattern="08[0-9]{7,11}"
                                    required>
                            </div>
                        </div>
                        ...
                        <!-- Alamat Email -->
                        <div>
                            <label for="email" class="block text-sm font-medium text-gray-700 mb-1">Alamat E-mail
                                <span class="text-red-500">*</span></label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                ...
                                <input type="email" name="email" id="email"
                                    class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                                    placeholder="Masukkan alamat email (xxx@xxx)" required>
                            </div>
                        </div>

                        <!-- Permohonan -->
                        <div class="md:col-span-2">
                            <label for="permohonan" class="block text-sm font-medium text-gray-700 mb-1">Permohonan
                                <span class="text-red-500">*</span></label>
